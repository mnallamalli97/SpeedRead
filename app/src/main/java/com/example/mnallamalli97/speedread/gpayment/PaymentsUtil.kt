...
import com.example.mnallamalli97.speedread.gpayment.Constants
...
object PaymentsUtil {
  ...
  private fun gatewayTokenizationSpecification(): JSONObject {
    return JSONObject().apply {
      ...
      put("parameters", JSONObject(
          Constants.PAYMENT_GATEWAY_TOKENIZATION_PARAMETERS as Map<*, *>))
    }
  }
  ...
  private fun directTokenizationSpecification(): JSONObject {
    ...
    return JSONObject().apply {
      put("type", "DIRECT")
      put("parameters", JSONObject(
          Constants.DIRECT_TOKENIZATION_PARAMETERS as Map<*, *>))
    }
  }
